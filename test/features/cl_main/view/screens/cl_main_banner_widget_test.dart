...
void main() {
  ...
  testWidgets(
    'shows cleaning banner and switches to occasions list',
    (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        TickerMode(
          enabled: false,
          child: MaterialApp(home: ClMainScreen(bloc: bloc)),
        ),
      );
    ...
    skip: true,
  ); // ClMainScreen pumpWidget hangs in widget-test env (same as cl_main_screen_test)
}
