...
void main() {
  test(
    'keeps no-travel actions available after the initial report is recorded',
    () {
  ...
  test(
    'explicit empty contract prevents legacy flags from enabling actions',
    () {
  ...
  test(
    'legacy attendance capabilities remain compatible before backend rollout',
    () {
      final session = CleaningBookingSessionModel.fromJson(<String, dynamic>{
        'id': 901,
        'sequence': 1,
