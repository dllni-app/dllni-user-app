...
class RsAppSimpleAppBarWithSearch extends StatefulWidget {
  ...
  @override
  State<RsAppSimpleAppBarWithSearch> createState() =>
      _RsAppSimpleAppBarWithSearchState();
}

class _RsAppSimpleAppBarWithSearchState
    extends State<RsAppSimpleAppBarWithSearch> {
  @override
  Widget build(BuildContext context) {
    return Container(
      width: context.width,
                  ...
                  child: Row(
                    children: [
                      _SearchModeChip(
                        ...
                        isSelected:
                            state.activeSearchMode == RsDiscoverSearchMode.meal,
                      ...
                      _SearchModeChip(
                        ...
                        isSelected:
                            state.activeSearchMode ==
                            RsDiscoverSearchMode.restaurant,
                        onTap: () =>
                            _onModeSelected(RsDiscoverSearchMode.restaurant),
                      ),
                      const SizedBox(width: 8),
                      _SearchModeChip(
                        label: "بحث ذكي",
                        ...
                        isSelected:
                            state.activeSearchMode ==
                            RsDiscoverSearchMode.smart,
                        onTap: () =>
                            _onModeSelected(RsDiscoverSearchMode.smart),
                      ),
                    ],
                  ),
                );
  ...
  void _dispatchSearchForMode(String value, RsDiscoverSearchMode mode) {
    ...
    bloc.add(
      DiscoverProductSearchQueryChangedEvent(
        value,
        resultingMode: mode == RsDiscoverSearchMode.smart
            ? RsDiscoverSearchMode.smart
            : null,
      ),
    );
          ...
          children: [
            CircleAvatar(
              ...
              child: FaIcon(
                icon,
                size: 12,
                color: isSelected ? context.onPrimary : Colors.white,
              ),
            ),
            const SizedBox(width: 8),
            AppText(
