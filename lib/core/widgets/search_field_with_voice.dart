...
class SearchFieldWithVoice extends StatelessWidget {
  const SearchFieldWithVoice({super.key, required this.onSearch, required this.onVoiceTap, this.backgroundColor = const Color(0xFFF9FAFB)});
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: TextStyle(color: Color(0xFF9CA3AF), fontSize: 14, fontWeight: FontWeight.w500, height: 26 / 14),
        ...
        suffixIcon: Padding(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(color: Color(0x1A1E2A78), borderRadius: BorderRadius.all(Radius.circular(8))),
