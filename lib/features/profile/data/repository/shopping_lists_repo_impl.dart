...
class ShoppingListsRepoImpl with HandlingException implements ShoppingListsRepo {
  ...
  DataResponse<ShoppingListDetailResponseModel> fetchShoppingListDetail(
    ...
    return wrapHandlingException(
      tryCall: () => shoppingListsRemoteDataSource.fetchShoppingListDetail(params),
    );
  }
  ...
  DataResponse<ShoppingListDetailResponseModel> updateShoppingListItem(
    ...
    return wrapHandlingException(
      tryCall: () => shoppingListsRemoteDataSource.updateShoppingListItem(params),
    );
  }
  ...
  DataResponse<ActionResultModel> deleteShoppingListItem(
    ...
    return wrapHandlingException(
      tryCall: () => shoppingListsRemoteDataSource.deleteShoppingListItem(params),
    );
  }
  ...
  DataResponse<FetchRestaurantCartModel> addShoppingListToCart(
    ...
    return wrapHandlingException(
      tryCall: () => shoppingListsRemoteDataSource.addShoppingListToCart(params),
    );
  }
}
