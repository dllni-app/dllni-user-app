...
import 'package:dllni_user_app/features/auth/domain/usecases/login_use_case.dart';
          ...
          switch (state.loginStatus) {
            ...
            case BlocStatus.success:
              ...
              Navigator.of(context).pushAndRemoveUntil(
                MaterialPageRoute(builder: (_) => const RsMainScreen()),
                (route) => false,
              );
              break;
                              ...
                              return InkWell(
                                ...
                                onTap: () {
                                  ...
                                  context.read<AuthBloc>().add(
                                    LoginEvent(params: LoginParams(phone: _phoneController.text.trim(), password: _passwordController.text)),
                                  );
                                },
                                child: Container(
