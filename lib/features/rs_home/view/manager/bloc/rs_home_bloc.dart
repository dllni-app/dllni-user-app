...
class RsHomeBloc extends Bloc<RsHomeEvent, RsHomeState> {
  final FetchRestaurantHomeCategoriesUseCase
  fetchRestaurantHomeCategoriesUseCase;
  final FetchRestaurantHomeExclusiveOffersUseCase
  fetchRestaurantHomeExclusiveOffersUseCase;
  final FetchRestaurantHomeSuggestedProductsUseCase
  fetchRestaurantHomeSuggestedProductsUseCase;
  final FetchRestaurantHomeNearestRestaurantsUseCase
  fetchRestaurantHomeNearestRestaurantsUseCase;
  final FetchRestaurantHomeLatestOrderedProductsUseCase
  fetchRestaurantHomeLatestOrderedProductsUseCase;
  final FetchRestaurantHomeCategoryProductsUseCase
  fetchRestaurantHomeCategoryProductsUseCase;
  ...
  RsHomeBloc(
    ...
    on<FetchRestaurantHomeExclusiveOffersEvent>(
      _fetchRestaurantHomeExclusiveOffers,
    );
    on<FetchRestaurantHomeSuggestedProductsEvent>(
      _fetchRestaurantHomeSuggestedProducts,
    );
    on<FetchRestaurantHomeNearestRestaurantsEvent>(
      _fetchRestaurantHomeNearestRestaurants,
    );
    on<FetchRestaurantHomeLatestOrderedProductsEvent>(
      _fetchRestaurantHomeLatestOrderedProducts,
    );
    on<FetchRestaurantHomeCategoryProductsEvent>(
      _fetchRestaurantHomeCategoryProducts,
    );
  }
  ...
  FutureOr<void> _fetchStores(
    ...
    if (!state.stores!.isEndPage || event.isReload) {
      emit(
        state.copyWith(
          stores: state.stores!.setLoading(isReload: event.isReload),
        ),
      );
  ...
  FutureOr<void> _fetchNearByStores(
    FetchNearByStoresEvent event,
    Emitter<RsHomeState> emit,
  ) async {
  ...
  FutureOr<void> _fetchFeaturedOffers(
    FetchFeaturedOffersEvent event,
    Emitter<RsHomeState> emit,
  ) async {
  ...
  FutureOr<void> _fetchRestaurantHomeCategories(
    FetchRestaurantHomeCategoriesEvent event,
    Emitter<RsHomeState> emit,
  ) async {
    ...
    res.fold(
      (l) {
        emit(
          state.copyWith(
            restaurantCategoriesStatus: BlocStatus.failed,
            errorMessage: l.message,
          ),
        );
      },
      (r) {
        emit(
          state.copyWith(
            restaurantCategoriesStatus: BlocStatus.success,
            restaurantCategories: r,
          ),
        );
      },
    );
  ...
  FutureOr<void> _fetchRestaurantHomeExclusiveOffers(
    FetchRestaurantHomeExclusiveOffersEvent event,
    Emitter<RsHomeState> emit,
  ) async {
    ...
    res.fold(
      (l) {
        emit(
          state.copyWith(
            restaurantExclusiveOffersStatus: BlocStatus.failed,
            errorMessage: l.message,
          ),
        );
      },
      (r) {
        emit(
          state.copyWith(
            restaurantExclusiveOffersStatus: BlocStatus.success,
            restaurantExclusiveOffers: r,
          ),
        );
      },
    );
  ...
  FutureOr<void> _fetchRestaurantHomeSuggestedProducts(
    FetchRestaurantHomeSuggestedProductsEvent event,
    Emitter<RsHomeState> emit,
  ) async {
    ...
    res.fold(
      (l) {
        emit(
          state.copyWith(
            restaurantSuggestedProductsStatus: BlocStatus.failed,
            errorMessage: l.message,
          ),
        );
      },
      (r) {
        emit(
          state.copyWith(
            restaurantSuggestedProductsStatus: BlocStatus.success,
            restaurantSuggestedProducts: r,
          ),
        );
      },
    );
  ...
  FutureOr<void> _fetchRestaurantHomeNearestRestaurants(
    FetchRestaurantHomeNearestRestaurantsEvent event,
    Emitter<RsHomeState> emit,
  ) async {
    emit(
      state.copyWith(restaurantNearestRestaurantsStatus: BlocStatus.loading),
    );
    final res = await fetchRestaurantHomeNearestRestaurantsUseCase(
      event.params,
    );
    res.fold(
      (l) {
        emit(
          state.copyWith(
            restaurantNearestRestaurantsStatus: BlocStatus.failed,
            errorMessage: l.message,
          ),
        );
      },
      (r) {
        emit(
          state.copyWith(
            restaurantNearestRestaurantsStatus: BlocStatus.success,
            restaurantNearestRestaurants: r,
          ),
        );
      },
    );
  ...
  FutureOr<void> _fetchRestaurantHomeLatestOrderedProducts(
    FetchRestaurantHomeLatestOrderedProductsEvent event,
    Emitter<RsHomeState> emit,
  ) async {
    emit(
      state.copyWith(restaurantLatestOrderedProductsStatus: BlocStatus.loading),
    );
    final res = await fetchRestaurantHomeLatestOrderedProductsUseCase(
      event.params,
    );
    res.fold(
      (l) {
        emit(
          state.copyWith(
            restaurantLatestOrderedProductsStatus: BlocStatus.failed,
            errorMessage: l.message,
          ),
        );
      },
      (r) {
        emit(
          state.copyWith(
            restaurantLatestOrderedProductsStatus: BlocStatus.success,
            restaurantLatestOrderedProducts: r,
          ),
        );
      },
    );
  ...
  FutureOr<void> _fetchRestaurantHomeCategoryProducts(
    ...
    res.fold(
      (l) {
        emit(
          state.copyWith(
            restaurantCategoryProductsStatus: BlocStatus.failed,
            errorMessage: l.message,
          ),
        );
      },
