        ...
        BlocBuilder<RsHomeBloc, RsHomeState>(
          builder: (context, state) {
            if (state.restaurantNearestRestaurantsStatus ==
              ...
              final list =
                  state.restaurantNearestRestaurants?.nearestRestaurants ??
                  const [];
              return SizedBox(
                height: 220,
