  ...
  Widget build(BuildContext context) {
    return BlocBuilder<RsHomeBloc, RsHomeState>(
      builder: (context, state) {
        ...
        final list = state.restaurantLatestOrderedProducts?.latestOrderedProducts ?? const [];
        final isReorderLoading = state.restaurantReorderStatus == BlocStatus.loading;
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2),
                      AppText.labelSmall('يمكنك اعادة طلب طلبك الاخير', color: Color(0xFF6B7280)),
                    ],
                  ),
                ),
                ...
                InkWell(
                  onTap: isReorderLoading
                      ? null
                      : () {
                          context.read<RsHomeBloc>().add(ReorderLatestOrderedProductEvent());
                        },
                  ...
                  child: Container(
                    ...
                    child: isReorderLoading
                        ...
                        : AppText.labelLarge('اعد الطلب', color: context.onPrimary, fontWeight: FontWeight.bold),
                  ),
                ),
              ],
            ),
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: productId == null || productId <= 0
          ? null
          : () {
              context.pushRoute('/rs_product', arguments: ProductDetailsScreenParams(product: ProductPreviewData.fromLatestOrderedItem(item)));
            },
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: const TextStyle(color: Color(0xFF1A1A1A), fontSize: 14, fontWeight: FontWeight.w700, height: 24 / 16),
                    ),
                    ...
                    Text(
                      ...
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: const TextStyle(color: Color(0xFF6B7280), fontSize: 12, fontWeight: FontWeight.w500, height: 20 / 15),
                    ),
