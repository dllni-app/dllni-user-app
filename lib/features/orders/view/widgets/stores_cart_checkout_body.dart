...
class StoresCartCheckoutBody extends StatefulWidget {
  const StoresCartCheckoutBody({super.key, required this.onRefresh});

  final Future<void> Function() onRefresh;

  @override
  State<StoresCartCheckoutBody> createState() => _StoresCartCheckoutBodyState();
}

class _StoresCartCheckoutBodyState extends State<StoresCartCheckoutBody> {
