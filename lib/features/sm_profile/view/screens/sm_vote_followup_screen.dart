...
@AutoRoutePage()
class SmVoteFollowupScreen extends StatefulWidget {
  const SmVoteFollowupScreen({super.key});

  @override
  State<SmVoteFollowupScreen> createState() => _SmVoteFollowupScreenState();
}

class _SmVoteFollowupScreenState extends State<SmVoteFollowupScreen> {
